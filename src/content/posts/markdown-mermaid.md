---
title: Markdown 里的 Mermaid 图表
published: 2023-10-01
pinned: false
description: 用几个简单例子看看 Mermaid 图表在 Markdown 里怎么写。
tags: [Markdown, 博客, Mermaid, Firefly]
category: 文章示例
draft: false
---
# Markdown 里的 Mermaid 图表

如果你想在文章里把流程、关系或者步骤画得更直观，Mermaid 是个很顺手的选择。它的写法不算复杂，掌握几个基础图表后就够用了。
