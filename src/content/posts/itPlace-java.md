...
如果你刚开始学编程，我会更建议先碰一碰 C，再去看 Java。C 语言会把很多底层概念直接摊开给你看，比如变量、函数、内存和程序入口；而 Java 会在这个基础上，带你进入更清晰的面向对象世界。
...
**准备**：装好一个 C 编译器和 JDK 就行，IDE 不是必须，但会省很多事。

**建议**：别只看，尽量把每段代码亲手敲一遍再跑一下。
